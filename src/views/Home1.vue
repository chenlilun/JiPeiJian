...
export default {
  ...
  data() {
    return {
      ...
      guozhangDate: "",
      calendarShow: false,
      guozhangtime: new Date(2020, 5, 18),
      guozhangpop: false,
          ...
          if (this.tabType === 0) {
            if (this.materuakOdd.length > 0) {
              ...
              this.materuakOdd.forEach((i) => {
                if (i.oddList.length > 0) {
                  i.oddList.forEach((j, i) => {
                    if (cc[0] === j.SP_CODE.toString()) {
                      // Toast.success(cc[0]+"--------"+j.SP_CODE);
                      isFlag = true;
                      //  console.log(cc[0]+"--------"+j.SP_CODE);
                    } else {
                      //  Toast(`${cc[0]}${j.SP_CODE}${j}${i}"----不等----"`);
                      //  console.log("不等"+cc[0]+"--------"+j.SP_CODE);
                    }
                  });
                }
              });
